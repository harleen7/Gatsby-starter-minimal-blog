---
title: Searching on Google from specified locations
date: 2023-01-12
slug: /search-google-from-specified-locations
description: Searching on Google from a location you specify shouldn't be hard. Here a few ways I found to do it.
tags:
  - Tutorial
banner: ./banner.jpg
---
...
Tool for checking Google search results by location - [Geolocation search URLs Generator](https://obscurious.xyz/geolocation-serp/)
...
![Location-override](./location-override.png)
...
![boring-oregon](./boring-oregon.png)
